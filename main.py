...
def main(args):
    ...
    name_exp = dict_params['conv_layer']  +'_modelname_'+str(args.model_name)+'_drop_' + str(dict_params['drop']) + '_temp_' + str(args.temp) + '_lr' + str(args.learning_rate) + '_losstype_'+ str(args.loss_type)+ '_alpha_' + str(args.alpha) + '_wd' + str(args.weight_decay) + '_bs_' +str(batch_size)+ '_nout_' + str(args.nout)
...
def parser_args(parser):
    ...
    parser.add_argument('-bs','--bs', type=int, default=100,
                        help='Batchsize')
